...
const ProjectsSection = () => {
  ...
  const projectsData = [
    ...
    },
    {
      ...
      previewUrl: "https://chalani-portfolio-gamma.vercel.app/",
      technologies: ["Next.js", "Tailwind CSS"]
    },
    {
      id: 6,
      title: "Older Portfolio - Chalani Nadeesha",
      description: "Developed a responsive portfolio website using HTML, CSS to showcase projects, skills, and achievements with a clean UI/UX design",
      image: "/images/projects/project06.png",
      tag: ["All", "Design", "Web"],
      gitUrl: "https://github.com/chalani22/old_portfolio.git",
      previewUrl: "",
    ...
    },
    {
      ...
      description: "Implemented a secure authentication system using Python, Flask, SQLite, and JWT, enabling user registration, login, and token-based access control.",
